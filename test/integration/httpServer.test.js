/* eslint-env mocha */
const debug = require('debug')('test:integration:httpServer'); // eslint-disable-line no-unused-vars
...
describe('#httpServer', function() {
  ...
  it('should test that the httpServer integration test suite is setup', function(done) {
